...
(meditations
  ...
  "You can create a set by converting another collection, yes, any collection"
  (= #{3} (set [3]))

  "You can create a set by converting another collection, strings are not an exclusion"
  (= #{\1 \2 \3} (set "123"))
